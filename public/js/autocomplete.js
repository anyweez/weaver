            ...
            var i,
                ...
                defaultParams = {
                    ...
                    select: function (input, item) {
                        attr(input, {
                            "data-autocomplete-old-value": input.value = attr(item, "data-autocomplete-value", item.innerHTML)
                        });
                    },
...
function attrClass(item, value) {
    if (item) {
        return attr(item, typeof value === undefined ? "class" : {
            "class": value
        });
    }
}
